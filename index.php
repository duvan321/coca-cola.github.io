...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Coca cola la bebidas  de todos los colombianos"
    />
    <meta name="keywords" content="bebidas, gaseosa, coca, cola" />
    <title>Inicio - coca cola</title>
    <meta name="Author" lang="es" content="Diego Patiño" />
    ...
    <script
      src="https://kit.fontawesome.com/5bfe4be00d.js"
  ...
  <body>
    ...
    <main>
      <section id="inicio">
        <img src="images/bannerprincipal.jpg" alt="bannerprincipal" />
        <div class="bloque-inicio">
          <h1>Bienvenidos a cocacola</h1>
          <p>
        ...
        <div class="container">
          <div class="row">
            <div class="columna columna-33 columna-mobile-100">
              <div class="bloque-servicio">
                <div class="bloque-img-servicio cuadrado-perfecto">
                  <img src="images/servicio1.jpg" alt="servicio1" />
                </div>
                <div class="bloque-contenido-servicio">
                  <h3>Servicio 1</h3>
                  <p>
                    al contrario de usar textos como por ejemplo "Contenido
                    aquí, contenido aquí". Estos textos hacen parecerlo un
                    español que se puede leer
                  </p>
            ...
            <div class="columna columna-33 columna-mobile-100">
              <div class="bloque-servicio">
                <div class="bloque-img-servicio cuadrado-perfecto">
                  <img src="images/servicio2.jpg" alt="servicio2" />
                </div>
                <div class="bloque-contenido-servicio">
                  <h3>Servicio 2</h3>
                  <p>
            ...
            <div class="columna columna-33 columna-mobile-100">
              <div class="bloque-servicio">
                <div class="bloque-img-servicio cuadrado-perfecto">
                  <img src="images/servicio3.jpg" alt="servicio3" />
                </div>
                <div class="bloque-contenido-servicio">
                  <h3>Servicio 3</h3>
                  <p>
      ...
      <section id="galeria">
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="columna-33 columna-mobile-50">
              <div class="cuadrado-perfecto">
                <img src="images/servicio4.jpg" alt="servicio4" />
                <h4>Imagen4</h4>
              </div>
            </div>
            <div class="columna-33 columna-mobile-50">
              <div class="cuadrado-perfecto">
                <img src="images/servicio5.jpg" alt="servicio5" />
                <h4>Imagen5</h4>
              </div>
            </div>
            <div class="columna-33 columna-mobile-50">
              <div class="cuadrado-perfecto">
                <img src="images/servicio6.jpg" alt="servicio6" />
                <h4>Imagen6</h4>
              </div>
            </div>
          </div>
      ...
      <section id="contactenos" class="seccion">
        <iframe
          ...
          frameborder="0"
          id="gmap_canvas"
          src="https://maps.google.com/maps?width=520&amp;height=400&amp;hl=en&amp;q=%20chinchina+(Colombia)&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
        ></iframe>
        <div class="container-fluid">
          <div class="row">
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="columna columna-25 columna-mobile-100">
            <img src="images/logo-blanco.png" alt="" class="logo-footer" />
            <p>
          ...
          <div class="columna columna-25 columna-mobile-100">
            ...
            <ul>
              <li>diegoduvan321@gmail.com</li>
              <li>+573138401274</li>
              <li>
                cll 6 #11-41 chinchina <br />
                caldas Colombia
              </li>
            </ul>
          </div>
      ...
      <div class="barra-footer">&copy; Derechos Relacionados - 2023</div>
    </footer>
